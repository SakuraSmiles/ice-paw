      ...
      <nav class="settings-nav">
        ...
        >
          <span class="nav-icon">
            ...
            <!-- 模型图标（layers） -->
            <svg v-else-if="cat.icon === 'models'" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
