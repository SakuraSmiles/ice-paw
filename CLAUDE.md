...
- `cargo test --lib` 1465 passed / 0 failed（+ 集成测试：session_runner_e2e 12、session_reconcile_e2e 6+2 ignored、session_event_log_e2e 3、memory_e2e 3、message_repo 7、provider 11）；clippy --tests -D warnings 0 警告；vitest 501（1465/501 = MA-3 后 1443/484 + 批③ 新增 22+17：后端 anatomy 5/system_prompt 2/os_context 1/token 1/turn_cost 10/event_log 1/repo 1/derive 1 + e2e kind 序 6 处既有断言扩；前端 missHint 7/BudgetPill 3/useTrajectory 2/Inspector 5）
