...
- `cargo test --lib` 1473 passed / 0 failed（+ 集成测试：session_runner_e2e 12、session_reconcile_e2e 6+2 ignored、session_event_log_e2e 3、memory_e2e 3、message_repo 7、provider 11）；clippy --tests -D warnings 0 警告；vitest 522（1473/522 = MA-3 二轮批后 1473/514 + 审计批新增 8：useEscapeStack 谓词三形态+pop 4 / ChatHeader Esc 1 / chat 外部回合双形态+在途拦截 3）
