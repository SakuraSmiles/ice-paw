...
- **频道不像群聊、更像只和统筹者聊**（生产实案取证：19 条用户广播全部由统筹者独答；被要求「问问其他人」时统筹者转用委派——四名成员在用户看不见的子会话里答完，频道只收到一张汇总表）：频道成员回合的提示词此前既无成员名册也无角色语境——统筹者不知道自己可以分派、不知道能 @ 谁。三种触发语境的事实简报（广播接令 / 用户点名 / 成员接力）现在全部注入成员名册（统筹者带标注）；广播接令臂明确统筹职责——更适合某位成员的问题就 @其名字分派（可多 @、被 @ 者在频道接力发言），不必事事亲自答；频道协作纪律同时披露「委派子会话对频道不可见，需要成员成果进入频道对话用 @」。委派工具在频道照常可用（任务分发与频道接力正交）——改动是让模型知情选对通道，不是收走工具。
